...
import { getAvailableOrders, acceptOrder, getAssignedOrders, updateDeliveryStatus, rejectOrder } from "./order/index.js";
...
router.put("/orders/:id/reject", authorization, checkRole(["agent", "deliveryAgent"]), rejectOrder);
